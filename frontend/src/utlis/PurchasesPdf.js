...
import { calculateBalance, calculateFinalBalance, formatDate } from "./functions";
...
const generatePdf = (ledgerDetails,) => {
    ...
    const tableOptions = {
        ...
        head: [
            [
                { content: "Inoice #", styles: { fillColor: [35, 210, 253] } },
                { content: "Description", styles: { fillColor: [35, 210, 253] } },
                { content: "Total Amount", styles: { fillColor: [35, 210, 253] } },
